...
class KouteiEditForm(ModelForm):
    name = forms.CharField(label='品目名称', required=False, max_length=50,
    ...
    yosoku = forms.CharField(label='予測生産', required=False, max_length=10,
                             widget=forms.TextInput(attrs={'readonly': True}))
    ...
    unit = forms.CharField(label='単位', required=False, max_length=50, widget=forms.HiddenInput())
    ctype = forms.CharField(label='調理種別', max_length=50, required=False, widget=forms.HiddenInput())
